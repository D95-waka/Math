...
\begin{proof}
	יהי $\delta > 0$, לכל $x, y \in [0, \infty)$ אשר מקיימים $\lvert x - y \rvert < \delta$ מתקיים: % chktex 9
	\begin{align*}
		\lvert f(x) - f(y) \rvert
	...
	\[
		...
		< \delta
	\]
	לכל $\epsilon > 0$ נגדיר $\delta = \epsilon$ ולכן בהתאם להגדרה 5.46 $f$ רציפה במידה שווה בתחום $[1, \infty)$. \\* % chktex 9
	ממשפט קנטור עבור התחום $[0, 1]$ נובע כי $f$ רציפה במידה שווה בתחום $[0, \infty)$ % chktex 9
\end{proof}
